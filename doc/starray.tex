...
Besides a fairly recent kernel (as recent as \Bhack[2026/06/01], see \cite{l3kernel}), the packages \tsobj[pkg]{pkginfograb}\cite{pkginfograb} (for package documentation) and \tsobj[pkg]{tokglobalstack}\cite{tokglobalstack} (stack implementation for the iterate over commands see \ref{iterate-over}) are also used.
