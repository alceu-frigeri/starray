...
%%
%% This is version {1.4} {2025/08/04}
%%
...
%\starray_get_iter:n {STtest.TT.ZX}
...
%\cs_show:N\__starray_parser:nnTF
%\cs_show:N \starray_get_cnt:nNTF
%\cs_show:N \starray_parsed_get_cnt:NNNTF

%\cs_show:N \starray_if_in:nnTF
%\cs_show:N \starray_parsed_if_in:NNnTF

%\cs_show:N \starray_parsed_get_cnt_p:NNN
%\cs_show:N \starray_parsed_get_cnt_p:N
%\cs_show:N \__starray_parsed_nocheck_get_cnt_p:N
%\cs_show:N \__starray_parsed_checked_get_cnt_p:N
...
%\seq_new:N \__my_seq
%%\seq_put_right:Nn \__my_seq {(1st)}
%%\seq_put_right:Nn \__my_seq {(2nd)}
%\seq_map_inline:Nn \__my_seq {#1}
%\par


%\cs_show:N \tl_use:N

%\cs_show:N \regex_replace_all:NnN

%\cs_show:N \starray_set_prop:nnn
%\cs_show:N \starray_set_prop:nnnTF
%\cs_show:N \starray_set_iter:nn
%\cs_show:N \starray_set_iter:nnTF
%\cs_show:N \__starray_set_from_keyval:nn
%\cs_show:N \__starray_set_from_keyval:nnTF


%\cs_show:N \c_space_token
%\cs_show:N \c_space_tl
%\token_show:N \c_space_token
%\tl_show:N \c_space_token
%\tl_show:N \c_space_tl
